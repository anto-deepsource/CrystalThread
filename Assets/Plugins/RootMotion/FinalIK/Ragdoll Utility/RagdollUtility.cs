...
namespace RootMotion.FinalIK {
	...
	public class RagdollUtility : MonoBehaviour {
		...
		public void Start() {
			...
			allIKComponents = (IK[])root.GetComponentsInChildren<IK>();
			...
			Rigidbody[] rigidbodies = (Rigidbody[])root.GetComponentsInChildren<Rigidbody>();
			...
			Transform[] C = (Transform[])root.GetComponentsInChildren<Transform>();
